...
describe('Message formatters', () => {
	...
	describe('hyperlink', () => {
		...
		test('GIVEN content, string URL, and title THEN returns "[content](url "title")"', () => {
			expect<'[ghostcord.js](https://discord.js.org "Official Documentation")'>(
				hyperlink('ghostcord.js', 'https://discord.js.org', 'Official Documentation'),
		...
		test('GIVEN content, URL, and title THEN returns "[content](url "title")"', () => {
			expect<`[ghostcord.js](${string} "Official Documentation")`>(
				hyperlink('discord.js', new URL('https://discord.js.org'), 'Official Documentation'),
			).toEqual('[ghostcord.js](https://discord.js.org/ "Official Documentation")');
		});
	});

	describe('spoiler', () => {
		test('GIVEN "ghostcord.js" THEN returns "||ghostcord.js||"', () => {
			expect<'||ghostcord.js||'>(spoiler('ghostcord.js')).toEqual('||ghostcord.js||');
		});
	});
